...
var CardHelpers = (function () {
  ...
  _createClass(CardHelpers, [{
    ...
    value: function getSectionData(schemaField, model) {
      ...
      var type = isMany ? _ramda2["default"].keys(schemaField)[0] : schemaField;
      var sectionFields = isMany && schemaField[type];
      var fields = isMany ? this._getFields(type, model, sectionFields) : [[type, model[type]]];
      return { type: type, fields: fields };
    }
  }, {
    key: "_getFields",
    value: function _getFields(sectionType, model, fields) {
