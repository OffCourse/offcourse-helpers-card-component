...
var CardHelpers = (function () {
  ...
  _createClass(CardHelpers, [{
    key: "_partition",
    value: function _partition(schema, model, context) {
      var _this = this;

      var contextSchema = this._getSchema(schema, context);
      var partitions = _ramda2["default"].map(function (schemaField) {
        var _getSectionData = _this.getSectionData(schemaField, model);

        var sectionTitle = _getSectionData.sectionTitle;
        var fields = _getSectionData.fields;
    ...
    value: function getSectionData(schemaField, model) {
      ...
      var fields = isMany ? this._getFields(sectionTitle, model, sectionFields) : [model[sectionTitle]];
      return { sectionTitle: sectionTitle, fields: fields };
    }
  }, {
    key: "_getFields",
