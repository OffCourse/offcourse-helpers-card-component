...
var CardHelpers = (function () {
  ...
  _createClass(CardHelpers, [{
    ...
    value: function getSectionData(schemaField, model) {
      ...
      var title = isMany ? _ramda2["default"].keys(schemaField)[0] : schemaField;
      var sectionFields = isMany && schemaField[title];
      var fields = isMany ? this._getFields(title, model, sectionFields) : [[title, model[title]]];
      return { title: title, fields: fields };
    }
  }, {
    key: "_getFields",
